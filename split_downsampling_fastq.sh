...
echo "Your file, " $i " has the following number of lines" $fastqlineno
if (( $fastqlineno > 2147483647 ));
then
echo "You will need to split your fastq file further in order to proceed as it still has too many lines to be read in by R"; 
else
